...
otra lineas más \tuna tabulación, 
	...
	print ("El primer índice es donde empieza la subcadena (se incluye el carácter).")
	print ("El segundo índice es donde acaba la subcadena (se excluye el carácter).")
	print ("---")
	print("Imprimir los primeros 2 caractéres (el segundo índice se excluye) ==> palabra[0:2]")
	print (palabra[0:2])
